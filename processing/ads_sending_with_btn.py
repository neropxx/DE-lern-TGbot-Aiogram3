...
async def sending_with_btn(author_id: int,
                           text: str,
                           photo_id: int,
                           ikb_to_send: types.InlineKeyboardMarkup,
                           regim: str) -> None:
    """
    Функция выполняет рассылку рекламных сообщений в формате текст+фото+кнопка
    ...
    :param ikb_to_send: объект инлайн клавиатуры с рекламной кнопкой
